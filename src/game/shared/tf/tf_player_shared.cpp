...
ConVar tf_sniper_rifle_trails_forced("tf_sniper_rifle_trails_forced", "0", FCVAR_REPLICATED | FCVAR_NOTIFY, "If set, the value of tf_sniper_rifle_trails will override the trail of rifles that already have one.");
